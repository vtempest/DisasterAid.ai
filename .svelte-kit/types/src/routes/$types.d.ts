...
type LayoutRouteId = RouteId | "/" | "/assistant/[assistantId]" | "/assistants" | "/conversation/[id]" | "/conversations" | "/login" | "/login/callback" | "/logout" | "/models" | "/models/[...model]" | "/privacy" | "/r/[id]" | "/settings/(nav)" | "/settings/(nav)/assistants/new" | "/settings/(nav)/assistants/[assistantId]" | "/settings/(nav)/assistants/[assistantId]/edit" | "/settings/(nav)/[...model]" | null
type LayoutParams = RouteParams & { assistantId?: string; id?: string; model?: string }
