...
export const actions = {
	...
	report: async ({ request, params, locals, url }: import('./$types').RequestEvent) => {
	...
	subscribe: async ({ params, locals }: import('./$types').RequestEvent) => {
	...
	unsubscribe: async ({ params, locals }: import('./$types').RequestEvent) => {
		const assistant = await collections.assistants.findOne({
			_id: new ObjectId(params.assistantId),
		});
	...
	unfeature: async ({ params, locals }: import('./$types').RequestEvent) => {
