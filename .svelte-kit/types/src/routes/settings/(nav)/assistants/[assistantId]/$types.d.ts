...
type RouteParams = { assistantId: string };
type RouteId = '/settings/(nav)/assistants/[assistantId]';
...
export type PageData = Expand<Omit<PageParentData, keyof Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/settings/(nav)/assistants/[assistantId]/+page.js').load>>>> & OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/settings/(nav)/assistants/[assistantId]/+page.js').load>>>>>>;
