...
type LayoutRouteId = RouteId | "/settings/(nav)" | "/settings/(nav)/assistants/new" | "/settings/(nav)/assistants/[assistantId]" | "/settings/(nav)/assistants/[assistantId]/edit" | "/settings/(nav)/[...model]"
type LayoutParams = RouteParams & { assistantId?: string; model?: string }
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/settings/+layout.server.js').load>>>>>>;
