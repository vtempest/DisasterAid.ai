...
export const getAvailableChatModelProviders = async () => {
  ...
  if (openAIApiKey) {
    try {
      ...
      logger(`Error loading OpenAI models: ${err}`);
    }
  }
  ...
  if (groqApiKey) {
    try {
      ...
      logger(`Error loading Groq models: ${err}`);
    }
  }
  ...
  if (ollamaEndpoint) {
    try {
      ...
      logger(`Error loading Ollama models: ${err}`);
    }
  }
...
export const getAvailableEmbeddingModelProviders = async () => {
  ...
  if (openAIApiKey) {
    try {
      ...
      logger(`Error loading OpenAI embeddings: ${err}`);
    }
  }
  ...
  if (ollamaEndpoint) {
    try {
      ...
      logger(`Error loading Ollama embeddings: ${err}`);
    }
  }
